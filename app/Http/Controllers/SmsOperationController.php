    ...
    public function sms_sending(Request $request)
    {
        ...
        if($clientServiceData[0]->status === 0){
            ...
            try {
                ...
                $outputData = $client->messages->create($receiverNumber, [
                    'from' => $twilio_number, 
                    'body' => $message]);
                
                //Sent SMS ID generated by Twilio API
                $returnSID = array("Message SID"=>$outputData->sid);
                ...
                $sms_meta_data->save();
                return $this->sendResponse([$returnSID],'SMS Sent Successfully.');
            } catch (Exception $e) {
